...
Entity.createCombatAgent = function(prefab, x, y, z, obj) {
    ...
    agent.actionIntervalMs = 5000;
    agent.action = agent.tapAction = agent.slingshotAction = shootAction;
    agent.start();
